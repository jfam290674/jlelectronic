...
class InvoiceSerializer(serializers.ModelSerializer):
    ...
    def validate(self, attrs: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Aquí podríamos agregar una validación sencilla de fecha_emision:
        # - no futura
        # - no excesivamente antigua
        # Pero la validación dura de rango SRI la estamos manejando fuera
        # para no romper la relación con la clave de acceso.
