 ...
 * Stock
 * ==========================================================================*/
export function listStock(params?: StockListParams): Promise<Paginated<StockItem>> {
...
/** Técnicos - read-only */
export function listTechStock(params?: StockListParams): Promise<Paginated<StockItem>> {
  const qp: Record<string, any> = { ...(params || {}) };
  qp.use_full = 1;
  if (typeof params?.negatives === "boolean") qp.negatives = params.negatives ? "1" : "0";
